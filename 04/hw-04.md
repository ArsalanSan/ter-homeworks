...
Исходный код выполненного задания расположен в директории [**04/demonstration1**](https://github.com/ArsalanSan/ter-homeworks/tree/main/04/demonstration1/)
...
3. Используя оба модуля, создайте кластер example из одного хоста, а затем добавьте в него БД test и пользователя app. Затем измените переменную и превратите сингл хост в клас![task4_1.png](img%2Ftask4_1.png)
![task4_2.png](img%2Ftask4_2.png)
![task4_3.png](img%2Ftask4_3.png)
![task4_4.png](img%2Ftask4_4.png)тер из 2х серверов.
